...
5. Finally, add a review section to the todo.md file with a summary of the changes
...
You can launch multi-agents at any time to solve the tasks I give you.

Regularly do git commits and save changes so we can revert back if things start to break.